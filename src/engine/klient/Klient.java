...
public class Klient extends Thread{
    ...
    private final int czasPlywania;
    ...
    public Klient(int numer, int tmp, int maxLos, Kasa kasa, BasenOlimpijski basenOlimpijski, BasenOlimpijskiPanel basenOlimpijskiPanel, BasenRekreacyjny basenRekreacyjny, BasenRekreacyjnyPanel basenRekreacyjnyPanel, Brodzik brodzik, BrodzikPanel brodzikPanel){
        ...
        if(this.wiek >= 18){
            ...
            if(this.liczbaDzieci > 0){
                if(((tmpN - this.liczbaDzieci) > tmp) ||
                   ((maxLos + this.liczbaDzieci) < liczbaN)){
            ...
            this.setName("[" + numer + " Dorosly]");
        }else {
            this.liczbaDzieci = 0;
            this.setName("[" + numer + " Dziecko]");
        }
    }
        ...
        try {
            while (!czyMoze){
                if(!SYMULACJA_RESET){
                    ...
                    kasa.opisKlienta(this);

                    /////////////////////////////////////////////////////////////////////////////////////////////////////////
                    while (SYMULACJA_BREAK || SYMULACJA_RESET || SYMULACJA_SERWIS) { if (SYMULACJA_RESET) { return; } Thread.sleep(100); }
                    /////////////////////////////////////////////////////////////////////////////////////////////////////////

                    kasa.koniecOpisuKlienta(this);
                    ...
                    if(this.czyMoze){
                        ...
                        kasa.wypisZbasenu(this);

                        /////////////////////////////////////////////////////////////////////////////////////////////////////////
                        while (SYMULACJA_BREAK || SYMULACJA_RESET) { if (SYMULACJA_RESET) { return; } Thread.sleep(100); }
                        /////////////////////////////////////////////////////////////////////////////////////////////////////////

                        kasa.koniecWypisZbasenu(this);
    ...
    public void opisKlient(){
        ...
        if(this.liczbaDzieci == 2){
            ...
            cena = String.valueOf(df.format(cenaf));
            dodajCene(cena);
            KlientPanel.dodajOpis("KLIENT: " + this.getName(),"WIEK: " + String.valueOf(this.wiek), "CZAS PLYWANIA: " + String.valueOf(this.czasPlywania), "JAKI BASEN: " + basen, "CZY VIP: " + VIP, "OPLATA: " + oplata, "LICZBA DZIECI: " + String.valueOf(this.liczbaDzieci),"DZIECKO 1:\nDziecko 1 --> " + this.getName(), "\tWIEK: " + String.valueOf(this.wiekDziecka[0]), "\tPAMPERS: " + pampers1, "", "", "");
        }else {
    ...
    public void wpisNaBasen(){
        if(this.jakiBasen == 0){
            ...
            if(this.liczbaDzieci > 0){
                for(int i = 0; i < liczbaDzieci; i++){
                    this.basenOlimpijski.dodajKlientaOlimp();
                    this.basenOlimpijskiPanel.dodajOpisBasenuOlimp("Dziecko " + (i + 1) + "-->" + this.getName() + " zaczyna pływać!");
                }
            }
            ...
            if(this.liczbaDzieci > 0){
                for(int i = 0; i < liczbaDzieci; i++){
                    ...
                    this.basenRekreacyjnyPanel.dodajOpisBasenuRek("Dziecko " + (i + 1) + "-->" + this.getName() + " zaczyna pływać!");
                }
            }
            ...
            if(this.liczbaDzieci > 0){
                for(int i = 0; i < liczbaDzieci; i++){
                    this.brodzik.dodajKlientaBro();
                    this.brodzikPanel.dodajOpisBasenuBro("Dziecko " + (i + 1) + "-->" + this.getName() + " zaczyna pływać!");
                }
            }
        }
    }
    ...
    public void wypisZBasenu(){
        if(this.jakiBasen == 0){
            ...
            if(this.liczbaDzieci > 0){
                for(int i = 0; i < liczbaDzieci; i++){
                        this.basenOlimpijski.usunKlientaOlimp();
                        this.basenOlimpijskiPanel.dodajOpisBasenuOlimp("\tDziecko " + (i + 1) + "-->" + this.getName() + " kończy pływać!");
                }
            }
        }else if(this.jakiBasen == 1){
            ...
            if(this.liczbaDzieci > 0){
                for(int i = 0; i < liczbaDzieci; i++){
                    ...
                    this.basenRekreacyjnyPanel.dodajOpisBasenuRek("\tDziecko " + (i + 1) + "-->" + this.getName() + " kończy pływać!");
                }
            }
        }else if(this.jakiBasen == 2){
            ...
            if(this.liczbaDzieci > 0){
                for(int i = 0; i < liczbaDzieci; i++){
                    this.brodzik.usunKlientaBro();
                    this.brodzikPanel.dodajOpisBasenuBro("\tDziecko " + (i + 1) + "-->" + this.getName() + " kończy pływać!");
                }
            }
        }
    }
